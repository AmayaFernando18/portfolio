...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
            <Image src={ isDarkMode ? assets.mylogo_dark : assets.mylogo} alt="mylogo" className='w-28 cursor-pointer mr-14' />
            </a>
            ...
            <button onClick={()=> setIsDarkMode(prev => !prev)}>
                ...
                <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt="arrow" className='w-3' /></a>
            ...
            <div className='absolute right-6 top-6' onClick={closeMenu}>
                ...
                <li><a className='font-Ovo' onClick={closeMenu} href='#achievemnts'>Achievements</a></li>
