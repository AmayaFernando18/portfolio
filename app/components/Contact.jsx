...
const Contact = ({isDarkMode}) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "9abd6222-ff66-489f-9c7b-417c088945b9");
    ...
    transition={{delay: 0.5, duration: 0.5}}
      ...
      transition={{delay: 1.3, duration: 0.6}}
        ...
        dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>
            Submit now <Image src={assets.right_arrow_white} alt='whitearrow' className='w-4' /></motion.button>
